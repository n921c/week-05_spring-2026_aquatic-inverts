...
|   └── w5-in-class-template.pdf
|   └── w5-in-class-template.qmd
...
The rendered key for the code in this repository is [here](https://github.com/n921c/week-05_spring-2026_aquatic-inverts/blob/main/code/week-05_in-class-KEY.pdf).
